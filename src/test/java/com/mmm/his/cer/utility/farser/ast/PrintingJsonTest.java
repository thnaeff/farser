...
import com.mmm.his.cer.utility.farser.ast.AstPrinter.AstPrintDirection;
...
public class PrintingJsonTest {
  ...
  /********************************************************************************************************
   * Kind of a messy proof-of-concept implementation to convert any formula into a JSON
   * representation.
   *
   * @author Thomas Naeff
   *
